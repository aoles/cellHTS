...
The \Rpackage{cellHTS} includes an example of a two-color screen performed 
with \textit{D. melanogaster} cells. Two reporters were used. 
The first reporter is specific for ...., while the second reporter is indicative of 
...
